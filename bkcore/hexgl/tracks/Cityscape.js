...
bkcore.hexgl.tracks.Cityscape = {
  ...
  buildScenes: function (ctx, quality) {
    ...
    skyshader.uniforms['tCube'].texture = this.lib.get(
      'texturesCube',
      'skybox.dawnclouds'
    );
    ...
    var startbanner = ctx.createMesh(
      scene,
